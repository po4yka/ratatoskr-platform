# operations/reconciliation Specification

## Purpose
An operation that stops showing signs of life reaches a truthful terminal state within a bounded time, through the one transition rule every other writer uses, without resurrecting afterwards and without touching anything still alive (ADR-0014).
