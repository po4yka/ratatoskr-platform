# observability/rate-limit-telemetry Specification

## Purpose
Every per-actor rate-limit decision this deployment makes is visible on the metrics surface, counted where it is decided, with a closed label set and no identifier of any kind.
