...
Lets an authenticated owner enumerate their own operations with explicit filters and a stable cursor, so operational views render lists without fetching identifiers one by one.
