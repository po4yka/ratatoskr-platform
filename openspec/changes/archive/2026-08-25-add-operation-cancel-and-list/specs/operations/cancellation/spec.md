...
Lets an authenticated owner ask Platform to stop one of their own non-terminal operations, with truthful idempotent answers for operations already finished, and cooperative downstream stop through the event bus.
